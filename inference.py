...
def generate(args, loader, g_ema, device):
    ...
    for i, data in enumerate(loader):
        ...
        if args.finetune:
            appearance = torch.cat([pred_img, pred_img], 1)
        else:
            if args.allview:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", type=str, default='/home/nas1_temp/dataset/deepfashion/our_test', help="path to the lmdb dataset")
    ...
    dataset = InferenceDataset(args.path, args.size, args.vol_feat_res)
